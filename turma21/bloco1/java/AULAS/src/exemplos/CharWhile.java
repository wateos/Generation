...
public class CharWhile {
	...
	public static void main(String[] args) {
		...
		// Assunto: Como tratar Char? e mecanismos de controle do laço while?
		//Dicas: Perguntas fechadas ou independentes: Usar apenas if isolado e variáveis auxiliares.
		//Perguntas dependentes ou condicionais: Usar if else(encadeamento).
		//Tipos númericos são grande e devem ser evitados se não for pra calculo como em sexo e opcao.
		...
		System.out.printf("Teste print char: %c",continua);//saida de char
